...
#include "custom_msgs/msg/detail/suction_force__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::SuctionForce & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::SuctionForce & ros_message)
{
  // Member: force_1
  cdr >> ros_message.force_1;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msgs
max_serialized_size_SuctionForce(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs::msg::SuctionForce;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msgs
max_serialized_size_key_SuctionForce(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::SuctionForce *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::SuctionForce *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SuctionForce__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const custom_msgs::msg::SuctionForce *>(
...
static size_t _SuctionForce__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SuctionForce(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SuctionForce__callbacks = {
  "custom_msgs::msg",
  "SuctionForce",
...
static rosidl_message_type_support_t _SuctionForce__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SuctionForce__callbacks,
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_SuctionForce__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, SuctionForce)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_SuctionForce__handle;
}
