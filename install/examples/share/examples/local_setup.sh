...
: ${AMENT_CURRENT_PREFIX:="/home/ethan/crimp_ws/install/examples"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/examples/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/examples/environment/path.sh"
