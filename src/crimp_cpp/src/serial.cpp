...
private:
        ...
        std::shared_ptr<custom_msgs::srv::WriteData::Response> response) 
    {
        ...
        RCLCPP_INFO(this->get_logger(), "sc_WriteData service called");
    }
        ...
        std::shared_ptr<custom_msgs::srv::SCWritePos::Response> response) 
    {
        ...
        RCLCPP_INFO(this->get_logger(), "sc_WritePos service called");
    }
        ...
        std::shared_ptr<custom_msgs::srv::ID::Response> response) 
    {
        ...
        RCLCPP_INFO(this->get_logger(), "sc_PWMMode service called");
    }
        ...
        std::shared_ptr<custom_msgs::srv::SCWritePWM::Response> response) 
    {
        ...
        RCLCPP_INFO(this->get_logger(), "sc_WritePWM service called");
    }
        ...
        std::shared_ptr<custom_msgs::srv::ID::Response> response) 
    {
        ...
        RCLCPP_INFO(this->get_logger(), "sc_ReadPos service called");
    }
        ...
        std::shared_ptr<custom_msgs::srv::STWritePos::Response> response) 
    {
        ...
        RCLCPP_INFO(this->get_logger(), "st_WritePos service called");
    }
        ...
        std::shared_ptr<custom_msgs::srv::ID::Response> response) 
    {
        ...
        RCLCPP_INFO(this->get_logger(), "st_ReadPos service called");
    }
